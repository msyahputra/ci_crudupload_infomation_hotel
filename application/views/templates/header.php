					...
					<div class="row">
						...
						<div class="col-xs-12 text-center menu-1 menu-wrap">
							<ul>
								...
								<a href="<?php echo site_url('admin_hotel/logout');?>"><button type="button" class="btn btn-danger">Logout Admin</button>
								</a></li>
								<li style="float: right;">
									 <img src="<?php echo base_url('assets/hotel/bootstrap/img/abc.jpg') ?>" style="width: 40px; height: 40px;" class="img-circle" alt="User Image"/>
									 <button type="button" class="btn"><?php echo $session_user['first_name'].' '.$session_user['last_name']; ?></button>
								</a>
								</li>
							</ul>
						</div>
